...
class Lint {
    ...
    lint_query_object(input) {
        if (!judge_object(input))
...
const generate_cdn_url = (relative_path) => {
    return `https://cdn.statically.io/gh/Robot-Inventor/stc-filter/main/${relative_path}`;
};
...
<<<<<<< HEAD
                url: `https://cdn.statically.io/gh/Robot-Inventor/stc-filter/main/dist/filter/${filter.dir}.json?dev=1`,
=======
                url: generate_cdn_url(`dist/filter/${filter.dir}.json`),
>>>>>>> 828fa79 (フィルターの形式のリントの実装を改善 #113)
                id: filter.id
            };
        }
        catch (e) {
